<?
    ...
    $query_recetas_etapa = $c1->query("SELECT id, imagen, nombre FROM recetas WHERE etapa='" . $_GET["etapa"] . "';");
    $recetas = [];
    while($resultado_receta = $query_recetas_etapa->fetch_array(MYSQLI_ASSOC)) {
